...
public class SpringDataDemoApplication implements CommandLineRunner {
	...
	// Uses PersonSpringDataRepository Interface
	@Autowired
	...
	// in Spring Data JPA - the repository method is ".save" instead of ".merge"
	@Override
	public void run(String... args) throws Exception {
		...
		// delete by id cannot be logged because it is a void function
